...
def make_tracker_params(context):
    ...
    context['info_hash'] = make_info_hash(file_info)
    request_params = {
...
def make_peer_list(raw_peer_info):
    peer_list = []
...
async def get_file(loop, context):
    #
    pass
...
def main():
    ...
    # tracker
    context['raw_metafile'] = read_file_binary(torrent_file_path)
    ...
    peers = make_peer_list(tracker_response[b'peers'])
    context['peers'] = peers
    # file
    main_task = loop.create_task(get_file(loop, context))
